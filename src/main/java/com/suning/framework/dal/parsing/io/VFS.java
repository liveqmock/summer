 ...
 */
package com.suning.framework.dal.parsing.io;
        ...
        for (int i = 0; vfs == null || !vfs.isValid(); i++) {
            ...
            try {
                ...
                if (vfs == null || !vfs.isValid()) {
                    logger.debug("VFS implementation " + impl.getName() +
   ...
   */
    protected static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        try {
            ...
            logger.error("Security exception looking for method " + clazz.getName() + "." + 
                    methodName + ".  Cause: " + e);
            return null;
        } catch (NoSuchMethodException e) {
            logger.error("Method not found " + clazz.getName() + "." + methodName + "." + 
                    methodName + ".  Cause: " + e);
            return null;
        }
    }
